...
public class OrderProductAdapter extends BaseAdapter {
     ...
     */
    @Override
    public OrderListBean.DataBean.ListBean.GoodsBean getItem(int position) {
    ...
    public String getGoodsTotalCount() {
        ...
        for (OrderListBean.DataBean.ListBean.GoodsBean bean : dataList) {
            if (!TextUtils.isEmpty(bean.getNum()) && TextUtils.isDigitsOnly(bean.getNum())) {

                total += Integer.valueOf(bean.getNum());
            }
        }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final OrderListBean.DataBean.ListBean.GoodsBean bean = dataList.get(position);
        if (bean != null) {
...
//            }
            ...
            holder.countTv.setText(Tools.concatAll(mContext.getString(R.string.quantity)+"：", bean.getNum()));
            holder.priceTv.setText(Tools.formatPriceText(bean.getAmount()));
            holder.priceTv.setTypeface(Typeface.defaultFromStyle(Typeface.BOLD));
        }
     ...
     */
    public void updateData(List<OrderListBean.DataBean.ListBean.GoodsBean> data, boolean isClearOld) {
        if (isClearOld) {
            dataList.clear();
        }
