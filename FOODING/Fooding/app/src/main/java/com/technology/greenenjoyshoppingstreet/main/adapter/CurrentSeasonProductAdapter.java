...
public class CurrentSeasonProductAdapter extends BaseAdapter {
     ...
     */
    public CurrentSeasonProductAdapter(Context mContext) {
...
/*
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.item_current_season_product, null);
...
//            }
    ...
    public List<ProductBean.DataBean.ListBean> getDataList() {
        return dataList;
    }
